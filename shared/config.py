...
TEMPORAL_TASK_QUEUE = os.getenv("TEMPORAL_TASK_QUEUE", "grocery-task-queue")
TEMPORAL_LEGACY_TASK_QUEUE = os.getenv("TEMPORAL_LEGACY_TASK_QUEUE", "grocery-task-queue-legacy")
